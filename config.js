...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'KING B2K ✓',
    ...
    BOT_INFO: process.env.BOT_INFO || 'KING B2K ✓; KING B2K ✓; 919654934474; https://i.imgur.com/pELkY7F.mp4',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'KING B2K ✓;KING B2K ✓;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'KING B2K ✓' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '919654934474,0',
       DEBUG: DEBUG
};
